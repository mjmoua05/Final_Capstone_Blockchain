...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        return _ownedTokensCount[owner].current(); //.current
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != currentOwner, "Approval cannot be to self");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == tokenOwner, "Cannot transfer if you are not token owner!");
        require(to != address(0), "Not a valid Address!");
...
contract CustomERC721Token is ERC721Metadata("MJToken", "MJT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
